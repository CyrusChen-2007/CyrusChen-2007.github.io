...
style:
  ...
  font_family: Optima, Baskerville, Songti
  ...
  first_screen:
    ...
    description: Here echoing and flowing are past tracks...
...
social_contact:
  ...
  links:
    ...
    github: https://github.com/CyrusChen-2007          # GitHub
    weixin:          # WeChat
    qq:              # QQ
    weibo:           # WeiBo
    zhihu:           # ZhiHu
    twitter:         # Twitter
    facebook:        # Facebook
    email: cyjcyjcccyj@gmail.com          # Email
...
comment:
  ...
  #      https://valine.js.org
  valine:
    appid: wTWYbKAxdPihl1XsWCS7aUIS-MdYXbMMI          # Your leancloud application appid
    appkey: 393FGNmRq93NwdSNR1IBdZia         # Your leancloud application appkey
    server_urls: https://wtwybkax.api.lncldglobal.com   # Your Server URL
    placeholder: Leave your thoughts...     # Input box placeholder
